            ...
            <div className="container mt-3 resume">
                ...
                <div className="row">
                    ...
                    <div className="col-12 text-center">
                        <p className="text-center">
                            ...
                            LinkedIn: <a href="https://www.linkedin.com/in/charles-jarquio-116210104/">https://www.linkedin.com/in/charles-jarquio-116210104/</a> <br />
                            GitHub: <a href="https://github.com/cjarquio">https://github.com/cjarquio</a> 
                        </p>
                    </div>
                </div>
                {/*Education*/}
                ...
                <div className="row">
                    ...
                    <div className="col-8 col-md-7">
                        <p>
                            <strong>Build Engineer, Microsoft (through Pactera)</strong><br />
                        </p>
                        <ul style={{ marginTop: -20 }}>
                            <li>Triaged build breaks</li>
                            <li>Investigated if the problem is related to code, tooling, or build environment</li>
                    ...
                    <div className="col-8 col-md-5">
                        <p>
                            <strong>Help Desk Technician, Pacxa (through TekSystems)</strong><br />
                        </p>
                        <ul style={{ marginTop: -20 }}>
                ...
                <div className="row">
                    ...
                    <div className="col-12">
                        <p>
                            <strong>ConFusion Website</strong><br />
                            Description: Mock restaurant website for the purpose of learning web/front-end development
                        </p>
                        <ul style={{ marginTop: -20, marginBottom: -5 }}>
                            <li>Created site as a Single Page Application using React library</li>
                            <li>Added site navigation, forms, and media</li>
                            <li>Stylized site using SASS</li>
                        </ul>
                        <p>Tools: Visual Studio, HTML, CSS/SASS, Bootstrap, jQuery, JavaScript, React/Redux</p>
                    </div>

                    <div className="col-12">
                        <p>
                            <strong>Kizel Security Website</strong><br />
                            Description: Worked as a three-man team to recreate and redesign the Kizel Security website using Bootstrap
                        </p>
                        <ul style={{ marginTop: -20, marginBottom: -5 }}>
